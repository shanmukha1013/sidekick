  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      <main className="max-w-7xl mx-auto p-12 text-center">
        <h1 className="text-4xl font-black mb-6">Find Talent</h1>
        <p className="text-xl text-muted-foreground mb-12">Discover the perfect freelancer for your next project.</p>
        <div className="mt-20 p-12 border border-dashed border-border rounded-3xl bg-card">
          <h2 className="text-2xl font-bold text-muted-foreground">Talent directory coming in Phase 4!</h2>
        </div>
      </main>
    </div>
  );
